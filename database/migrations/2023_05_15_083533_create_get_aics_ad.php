...
return new class extends Migration
{
    ...
    {
        $procedure = " DROP PROCEDURE IF EXISTS `get_aics_ad`;
        CREATE PROCEDURE `get_aics_ad` ()
        BEGIN
        ...
        where receive_comm_assignto_id = 'Administrative Division';
        END";
    ...
    {
        Schema::dropIfExists('get_aics_ad');
    }
};
