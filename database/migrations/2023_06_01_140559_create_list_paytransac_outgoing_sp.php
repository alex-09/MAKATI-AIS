...
return new class extends Migration
{
    ...
    {
        $procedure = " DROP PROCEDURE IF EXISTS `list_paytransac_outgoing_sp`;
        CREATE PROCEDURE `list_paytransac_outgoing_sp` ()
        BEGIN
    ...
    {
        Schema::dropIfExists('list_paytransac_outgoing_sp');
    }
};
