...
return new class extends Migration
{
    ...
    {
        $procedure = " DROP PROCEDURE IF EXISTS `get_aics_pcic`;
        CREATE PROCEDURE `get_aics_pcic` ()
        BEGIN
        ...
        where receive_comm_assignto_id = 'Processing of Claims and Internal Control'
    ...
    {
        Schema::dropIfExists('get_aics_pcic');
    }
};
