...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        select 	*
        from (
            SELECT id, payee_id,  DATE_FORMAT(created_at, '%M %d %Y ') AS date, CONCAT(last_name, ' ', first_name) AS complete_name,
            ...
            union 
            select id, payee_id, DATE_FORMAT(created_at, '%M %d %Y ') AS date, business_name as complete_name,
                        CONCAT(building_no, ' ', lot_no, ' ',street, ' ',barangay, ' ',municipality_city, ' ',province, ' ',country) AS complete_address,
            ...
            union 
            select id, payee_id, DATE_FORMAT(created_at, '%M %d %Y ') AS date, agency_name as complete_name,
                        CONCAT(building_no, ' ', lot_no, ' ',street, ' ',barangay, ' ',municipality_city, ' ',province, ' ',country) AS complete_address,
