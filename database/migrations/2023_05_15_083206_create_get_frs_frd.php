...
return new class extends Migration
{
    ...
    {
        $procedure = " DROP PROCEDURE IF EXISTS `get_frs_frd`;
        CREATE PROCEDURE `get_frs_frd` ()
        BEGIN
        ...
        where receive_comm_assignto_id = 'Financial Reporting Division'
    ...
    {
        Schema::dropIfExists('get_frs_frd');
    }
};
