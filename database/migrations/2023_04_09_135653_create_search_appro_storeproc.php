...
return new class extends Migration
{
    ...
    {
        $procedure = " DROP PROCEDURE IF EXISTS `searchAppro`;
        CREATE PROCEDURE `searchAppro`(IN budYear int(2), IN fundSrc int(2), 
        ...
        BEGIN
            ...
            AND ap.fund_source = fundSrc
            AND ap.department_code_id = dept
    ...
    {
        Schema::dropIfExists('search_appro_storeproc');
    }
};
