...
return new class extends Migration
{
    ...
    public function up()
    {
        $procedure = " DROP PROCEDURE IF EXISTS `exec_appro_update_report_realignment`;
        CREATE PROCEDURE `exec_appro_update_report_realignment` (IN aipcode VARCHAR(250), IN appro VARCHAR(250))
        BEGIN
    ...
    {
        Schema::dropIfExists('exec_appro_update_report_realignment');
    }
};
