...
use App\Repositories\BAT\TrustFund\CityAccountant\ObligationCARepository;

class ObligationCAController extends Controller
{
    private $reviewerRepo;

    public function __construct(ObligationCARepository $reviewerRepo)
    {
