<script setup>
import fursView from "./fursView.vue";
...
<template>
  <div v-if="showDetails | (showDetails === true)">
    <div class="container mt-4">
      <p
        class="capitalize text-3xl font-bold text-other-black text-center mt-4"
      >
    ...
    <div class="container grid justify-items-center p-0 mt-4">
      <div
        class="overscroll-y-contain scrollbar w-1850 1536:w-1458 xxxxl:w-1850"
      >
        <table
  ...
  <fursView v-if="!showDetails | (showDetails === false)" />
</template>
