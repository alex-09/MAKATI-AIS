      ...
      <table class="w-full text-sm text-center">
        <thead class="text-xs uppercase">
          <tr>
            ...
            <th scope="col" class="px-6 py-3">cafoa number</th>
            <th scope="col" class="px-6 py-3">name of office</th>
            <th scope="col" class="px-6 py-3">contract no.</th>
