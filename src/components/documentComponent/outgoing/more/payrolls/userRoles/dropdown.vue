...
<template>
    <Listbox 
        ...
        <div class="relative mt-1">
            ...
            >
            <ListboxOptions
                class="z-10 absolute mt-1 max-h-60 w-234 overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
            >
                <ListboxOption
