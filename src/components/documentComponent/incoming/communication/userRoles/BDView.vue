<template>
  ...
  <div v-else>
    ...
    <div class="container mt-4">
      <p class="uppercase sticky top-0 text-other-black text-2xl font-bold mb-4">
        for assignment
      </p>
    </div>
        ...
        <table class="divide-y w-[3800px] divide-gray-200 mr-8">
          <thead class="bg-gray-200 sticky top-0">
            <tr>
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 uppercase sticky top-0 w-133"
              >
                date
              </th>
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 uppercase sticky top-0 w-200"
              >
                number
              </th>
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 uppercase sticky top-0 w-[230px]"
              >
                sender
              </th>
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 uppercase sticky top-0 w-250"
              >
                type
              </th>
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 uppercase sticky top-0 w-[400px]"
              >
                subject
              </th>
              <th
              ...
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 uppercase sticky top-0 w-[240px]"
              >
                reply to
              </th>
              <th
              ...
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 uppercase sticky top-0 w-360"
              >
                action to be taken
              </th>
              <th
              ...
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 uppercase sticky top-0 w-232"
              >
                action
              </th>
            </tr>
        ...
        .then((response) => {
          ...
          if (Array.isArray(response.data.list)) {
            this.comms = response.data.list.filter((comm) => {
              return (
                (comm.cluster === "Financial Reporting Services" &&
                  comm.assign_to.includes("Jemuel Palles")) && comm.status !== "Closed" && comm.status !== "Cancelled" ||
                (comm.cluster === "All" &&
                  comm.assign_to.includes("Jemuel Palles")) && comm.status !== "Closed" && comm.status !== "Cancelled"
              );
            });
