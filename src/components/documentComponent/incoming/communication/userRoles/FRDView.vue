      ...
      <div class="grid grid-cols-4 gap-9 xxxxl:gap-40">
        <div class="grid grid-row-3 place-content-center">
          <div class="flex flex-row my-1 items-center">
            ...
            >
            <select
              class="w-234 h-32 border rounded px-2 pl-3 py-1 focus:outline-none focus-visible:ring-white focus:border-input-color border-input-color text-sm text-gray-500 sticky top-0"
          ...
          <div class="flex flex-row my-1 items-center">
            ...
            <input
              v-model="searchDRN"
              type="text"
              class="w-234 h-32 border rounded px-2 pl-3 focus:outline-none focus-visible:ring-white focus:border-input-color border-input-color text-sm text-gray-500 sticky top-0"
            />
          </div>
          <div class="flex flex-row my-1 items-center">
            <span class="font-semibold text-sm text-other-black w-110"
        ...
        <table class="divide-y w-[3800px] divide-gray-200 mr-8">
          <thead class="bg-gray-200 sticky top-0">
            <tr>
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 sticky top-0 uppercase w-133"
              >
                date
              </th>
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 sticky top-0 uppercase w-200"
              >
                number
              </th>
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 sticky top-0 uppercase w-[230px]"
              >
                sender
              </th>
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 sticky top-0 uppercase w-250"
              >
                type
              </th>
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 sticky top-0 uppercase w-[400px]"
              >
                subject
              </th>
              <th
              ...
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 sticky top-0 uppercase w-[240px]"
              >
                reply to
              </th>
              <th
              ...
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 sticky top-0 uppercase w-360"
              >
                action to be taken
              </th>
              <th
              ...
              <th
                scope="col"
                class="px-6 py-3 text-xs font-bold text-center text-gray-500 sticky top-0 uppercase w-232"
              >
                action
              </th>
            </tr>
        ...
        .then((response) => {
          ...
          if (Array.isArray(response.data.list)) {
            this.comms = response.data.list.filter((comm) => {
              return (
                (comm.cluster === "Financial Reporting Services" &&
                  comm.assign_to.includes("Clarence Regala")) && comm.status !== "Closed" && comm.status !== "Cancelled" ||
                (comm.cluster === "All" &&
                  comm.assign_to.includes("Clarence Regala")) && comm.status !== "Closed" && comm.status !== "Cancelled"
              );
            });
