...
import showEquityAPI from '../../../api_request/chartAccounts/current/equity'
...
export default {
        ...
        methods: {
            ...
            exportEquity() {
                ...
                axios
                    .get(`coa/exportEquity?date=${this.$route.query.date}`, {
                    ...
                    fileLink.download = `Equity_${date}_${title}.xlsx`;
