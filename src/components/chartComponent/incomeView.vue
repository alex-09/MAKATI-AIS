...
import showIncomeAPI from '../../api_request/chartAccounts/current/income'
import PendingView from './pending/pendingIncome.vue';
import PendingApprovalView from './pending/pendingApprovalIncome.vue';
import TableView from './table/tableIncome.vue';
  ...
  methods: {
    ...
    async createAccount() {
      try {
        ...
        const response = await axios.get("coa/showIncome");
        ...
        const createResponse = await axios.post("coa/enrollIncome", newAccount);
