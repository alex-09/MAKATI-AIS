<script>
import showLiabilityAPI from "../../api_request/chartAccounts/current/equity";
import PendingView from "./pending/pendingEquity.vue";
import PendingApprovalView from "./pending/pendingApprovalEquity.vue";
import TableView from "./table/tableEquity.vue";
  ...
  methods: {
    ...
    async createAccount() {
      try {
        ...
        const createResponse = await axios.post("coa/enrollEquity", newAccount);
