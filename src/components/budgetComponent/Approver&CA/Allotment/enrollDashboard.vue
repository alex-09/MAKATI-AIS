...
export default {
    ...
    methods: {
        fetchLists() {
            axios.get("allotment/listApproDivisionHead")
                .then((response) => {
...
<template>
    <div class="flex justify-center items-center m-8 relative">
        <span class="absolute left-0 text-[22px] font-bold text-[#0E4572] uppercase">approval of allotment</span>
        ...
        <div class="overflow-x-auto overscroll-x-contain max-h-[500px] w-1850 1536:w-1458 xxxxl:w-1850 xxxxl:max-h-[500px]">
            <table class="divide-y w-[3000px] divide-gray-200 mr-8">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr v-else v-for="list in filteredLists" :key="list.allot_id">
                        <td
                        ...
                        <td class="px-2 py-4 whitespace-nowrap text-center w-207">
                            <div class="flex flex-row gap-2 justify-center">
                                <button
                                    @click="pushToListView(list.allot_id, list.AIPCode)"
