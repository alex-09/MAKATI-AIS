<template>
  ...
  <div
    class="flex justify-center flex-col w-screen max-h border-[6px] border-[#FFECB3] m-8 p-8 rounded-[24px]"
  >
    <div class="mb-2">
      <span class="text-[22px] text-[#1890FF] font-bold"
        >Details for Approval</span
      >
    </div>
    <div class="flex flex-col gap-4">
      <div class="flex justify-between flex-row gap-[100px]">
        <div class="flex flex-row gap-4 items-center">
          <span
            class="h-[32px] w-[300px] text-[14px] font-semibold text-[#606060] flex items-center"
            >Budget Year</span
          >
          <span
            class="h-[32px] w-[300px] text-sm text-gray-500 flex items-center"
            >{{ responseData.budget_year_id }}</span
          >
        </div>
        <div class="flex flex-row gap-4 items-center">
          <span
      ...
      <div class="flex justify-between flex-row gap-[100px]">
        <div class="flex flex-row gap-4 items-center">
          ...
          <span
            class="h-[32px] w-[300px] text-sm text-gray-500 flex items-center"
            >{{ responseData.reference_document }}</span
          >
        </div>
        <div class="flex flex-row gap-4 items-center">
          <span
            class="h-[32px] w-[300px] text-[14px] font-semibold text-[#606060] flex items-center"
            >Type of Appropriation</span
          >
          <span
            class="h-[32px] w-[300px] text-sm text-gray-500 flex items-center"
            >{{ responseData.appro_type }}</span
          >
        </div>
      </div>
      ...
      <div class="flex justify-between flex-row gap-[100px]">
        <div class="flex flex-row gap-4 items-center">
          ...
          <span
            class="h-[32px] w-[300px] text-sm text-gray-500 flex items-center"
            >{{ responseData.department_name }}</span
          >
        </div>
        <div class="flex flex-row gap-4 items-center">
          <span
    ...
    <div class="flex flex-col gap-4">
      <div class="flex justify-between flex-row gap-[100px]">
        <div class="flex flex-row gap-4 items-center">
          <span
            class="h-[32px] w-[300px] text-[14px] font-semibold text-[#606060] flex items-center"
            >Title of the Program</span
          >
          <span
            class="h-[32px] w-[300px] text-sm text-gray-500 flex items-center"
            >{{ responseData.program }}</span
          >
        </div>
        <div class="flex flex-row gap-4 items-center">
          <span
            class="h-[32px] w-[300px] text-[14px] font-semibold text-[#606060] flex items-center"
            >AIP Code (Program)</span
          >
          <span
            class="h-[32px] w-[300px] text-sm text-gray-500 flex items-center"
            >{{ responseData.program_code }}</span
          >
        </div>
      </div>
      ...
      <div class="flex justify-between flex-row gap-[100px]">
        <div class="flex flex-row gap-4 items-center">
          <span
            class="h-[32px] w-[300px] text-[14px] font-semibold text-[#606060] flex items-center"
            >Title of the Project</span
          >
          <span
            class="h-[32px] w-[300px] text-sm text-gray-500 flex items-center"
            >{{ responseData.project }}</span
          >
        </div>
        <div class="flex flex-row gap-4 items-center">
          <span
            class="h-[32px] w-[300px] text-[14px] font-semibold text-[#606060] flex items-center"
            >AIP Code (Project)</span
          >
          <span
            class="h-[32px] w-[300px] text-sm text-gray-500 flex items-center"
            >{{ responseData.project_code }}</span
          >
        </div>
      </div>
    </div>
    ...
    <div class="flex justify-start flex-col mt-[30px]">
      <div class="flex justify-between flex-row gap-[100px]">
        <div class="flex flex-row gap-4 items-center">
          <span
            class="h-[32px] w-[300px] text-[14px] font-semibold text-[#606060] flex items-center"
            >Title of the Activity</span
          >
          <span
            class="h-[32px] w-[300px] text-sm text-gray-500 flex items-center"
            >{{ responseData.activity }}</span
          >
        </div>
        <div class="flex flex-row gap-4 items-center">
          <span
            class="h-[32px] w-[300px] text-[14px] font-semibold text-[#606060] flex items-center"
            >AIP Code (Activity)</span
          >
          <span
            class="h-[32px] w-[300px] text-sm text-gray-500 flex items-center"
            >{{ responseData.activity_code }}</span
          >
        </div>
      </div>
      <div class="flex flex-row gap-[100px]">
        <div class="flex flex-row gap-4 items-center">
          ...
          >
          <span
            class="h-[32px] w-[950px] text-sm text-gray-500 flex items-center"
            >{{ responseData.activity_description }}</span
          >
        </div>
      </div>
      <span class="text-[14px] text-[#606060] font-semibold mt-[20px]"
        >Details of Adjustments</span
      >
      <div class="flex justify-center">
        <table class="w-[750px] max-h divide-y divide-gray-200">
          <thead>
            <tr>
              <th
                class="text-[12px] uppercase text-[#3A3541] font-semibold py-2"
              >
                account code
              </th>
              <th
          ...
          <tbody class="divide-y divide-gray-200">
            <tr v-for="expense in responseData1" :key="expense.id">
              ...
              <td class="text-[14px] text-3A3541 text-center">
                {{ expense.appro_amount }}
              </td>
            </tr>
            <!-- DITO YUNG PANG ADD NG ADJUSTMENT -->
            <tr>
              <td class="text-[14px] text-3A3541 text-center h-[20px]"></td>
              <td class="text-[14px] text-3A3541 text-center"></td>
              <td class="text-[14px] text-3A3541 text-center"></td>
            </tr>
            <tr>
              <td class="text-[14px] text-3A3541 text-center">TOTAL</td>
              <td class="text-[14px] text-3A3541 text-center"></td>
              <td class="text-[14px] text-3A3541 text-center">
  ...
  <div
    v-if="
      this.userdesignation === 'Reviewer' &&
      this.position == 'Assistant Division Head'
    "
  >
    <div class="flex flex-col items-center justify-center my-[30px]">
      <span class="text-[14px] text-[#3A3541] uppercase font-semibold my-1"
      ...
      <textarea
        ...
        rows="2"
        v-model="remarks"
        class="text-[12px] rounded-[5px] border-[1px] focus:outline-none focus-visible:ring-white focus:border-input-color border-input-color"
      ></textarea>
    </div>
    <div class="flex flex-row justify-center items-center gap-14 mb-[20px]">
      <button
        class="uppercase text-[15px] font-medium text-white rounded-[5px] w-[209px] h-[42px] bg-[#16B1FF]"
        @click="ApprovalBtn()"
      >
        for approval - dh
      </button>
      <button
        class="uppercase text-[15px] font-medium text-white rounded-[5px] w-[115px] h-[42px] bg-danger-color"
        @click="RejectBtn()"
      >
        reject
      </button>
      <RouterLink
        :to="{ name: 'Enroll/New Dashboard Reviewer' }"
        class="uppercase text-[15px] font-medium text-white rounded-[5px] w-[115px] h-[42px] bg-danger-color cursor-pointer flex items-center justify-center"
        >cancel</RouterLink
      >
    </div>
  </div>
  <div
    v-if="
      this.userdesignation === 'Approver' && this.position == 'Division Head'
    "
  >
    <div class="flex flex-col items-center justify-center my-[30px]">
      <span class="text-[14px] text-[#3A3541] uppercase font-semibold my-1"
...
export default {
  ...
  async mounted() {
    // Call the fetchData() method to make the initial API request
    this.fetchData();
  },
  watch: {
  ...
  methods: {
    ...
    async ApprovalBtn() {
      ...
      const approvalResponse = await axios.post(
        "appropriation/updateApproForReview",
        ApprovalData
      );
      ...
      this.$router.push({ name: "Enroll/New Dashboard Reviewer" });
    },
    async RejectBtn() {
      const RejectData = {
        appro_id: this.id,
      ...
      const rejectResponse = await axios.post(
        "appropriation/rejectApproForReview",
        RejectData
      );
    ...
    async ApprovalBtnDH() {
      ...
      this.$router.push({ name: "Enroll/New Dashboard - Approver&CA" });
    },
    async RejectBtnDH() {
      const RejectData = {
        appro_id: this.id,
      ...
      try {
        ...
        if (this.userdesignation == "Reviewer") {
          const response = await axios.post(
            "appropriation/viewApproForReview",
            {
              appro_id: this.id,
              aipcode: this.aipcode,
            }
          ...
          const response = await axios.post("appropriation/viewApproDH", {
            appro_id: this.id,
            aipcode: this.aipcode,
          });
          this.responseData = response.data.main_info[0];
          ...
          const response = await axios.post("appropriation/viewApproAC", {
            appro_id: this.id,
            aipcode: this.aipcode,
          });
          this.responseData = response.data.main_info[0];
  ...
  computed: {
    totalAmount() {
      return this.responseData1.reduce((total, expense) => {
        return total + parseFloat(expense.appro_amount);
      }, 0);
    },
  },
};
