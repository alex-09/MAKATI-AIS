<template>
  ...
  >
    <div class="grid lg:grid-cols-[194px_auto] items-center">
      ...
      <div class="h-32 relative">
        ...
        <input
          ...
          v-model="trustReceipt.budgetYear"
          :disabled="childData ? 1 : 0"
        />
      </div>
    </div>
    <div class="grid lg:grid-cols-[194px_auto] items-center">
      <div class="font-semibold text-sm">Legal Basis:</div>
      <div class="h-32 relative">
        <!-- <Textbox
          :placeholder="'edit placeholder'"
          v-model="legalBasis"
        ...
        <input
          type="text"
          class="bg-[initial] text-sm border-[1px] border-[#3a354147] flex items-center cursor-default rounded-md w-full px-3 h-full focus:ring-0 focus:outline-none focus:border-[#3a354147] py-[auto]"
          v-model="trustReceipt.legalBasis"
          :disabled="childData ? 1 : 0"
        />
      </div>
    </div>
    ...
    <div class="grid lg:grid-cols-[194px_auto] items-center">
      <div class="font-semibold text-sm">Journal Entry Voucher No.:</div>
      <div class="h-32 relative">
        <!-- <Textbox
          :placeholder="'edit placeholder'"
          v-model="journalEntryVoucherNo"
          :value="journalEntryVoucherNo"
        /> -->
        <input
          type="text"
          class="bg-[initial] text-sm border-[1px] border-[#3a354147] flex items-center cursor-default rounded-md w-full px-3 h-full focus:ring-0 focus:outline-none focus:border-[#3a354147] py-[auto]"
          v-model="trustReceipt.journalEntryVoucherNo"
          :disabled="childData ? 1 : 0"
        />
      </div>
    </div>
    <div class="grid lg:grid-cols-[194px_auto] items-center">
      <div class="font-semibold text-sm">Journal Entry Voucher Date:</div>
      <div class="h-32 relative">
        <!-- <Textbox
          :placeholder="'edit placeholder'"
          v-model="journalEntryVoucherDate"
          :value="journalEntryVoucherDate"
        /> -->
        <input
          type="date"
          id="start"
          ...
          min="2018-01-01"
          max=""
          v-model="trustReceipt.journalEntryVoucherDate"
          :disabled="childData ? 1 : 0"
        />
      </div>
    </div>
...
<script setup>
import FundTitle2 from "./FundTitle2.vue";
...
export default {
  ...
  mounted() {
    // const data = this.journalEntryVoucherDate;
