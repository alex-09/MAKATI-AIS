<template>
  ...
  >
    <div class="grid md:grid-cols-[194px_auto] md:col-span-2 items-center">
      <div class="font-semibold text-sm">Type of Government:</div>
      <div class="h-32 relative">
        <!-- <Dropdown
          :dataArray="['Type of Government 1', 'Type of Government 2']"
          :placeholder="'Select Type of Government'"
        /> -->
        <select
          v-model="trustReceipt.typeOfGovernment"
          class="bg-[initial] text-sm border-[1px] border-[#3a354147] flex items-center cursor-default rounded-md w-full px-3 h-full focus:ring-0 focus:outline-none focus:border-[#3a354147] py-0"
        >
          <option value="" disabled>Select Type of Government</option>
          <option value="1">Type of Government 1</option>
          <option value="2">Type of Government 2</option>
        </select>
      </div>
    ...
    <div class="grid md:grid-cols-[194px_auto] md:col-span-2 items-center">
      <div class="font-semibold text-sm">Name of Agency:</div>
      <div class="h-32 relative">
        <!-- <Dropdown
          :dataArray="['Name of Agency 1', 'Name of Agency 2']"
          :placeholder="'Select Name of Agency'"
        /> -->
        <select
          v-model="trustReceipt.nameOfAgency"
          :disabled="childData ? 1 : 0"
          class="bg-[initial] text-sm border-[1px] border-[#3a354147] flex items-center cursor-default rounded-md w-full px-3 h-full focus:ring-0 focus:outline-none focus:border-[#3a354147] py-0"
        >
          <option value="" disabled>Select Type of Government</option>
          <option value="1">Name of Agency 1</option>
          <option value="2">Name of Agency 2</option>
        </select>
      </div>
    </div>
    <div class="grid md:grid-cols-[194px_auto] md:col-span-2 items-center">
    ...
    <div class="grid lg:grid-cols-[194px_auto] items-center">
      <div class="font-semibold text-sm">NADAI No.:</div>
      <div class="h-32 relative">
        <!-- <Textbox :placeholder="'edit placeholder'" /> -->
        <input
          type="text"
          class="bg-[initial] text-sm border-[1px] border-[#3a354147] flex items-center cursor-default rounded-md w-full px-3 h-full focus:ring-0 focus:outline-none focus:border-[#3a354147] py-[auto]"
          v-model="trustReceipt.nadaiNo"
          :disabled="childData ? 1 : 0"
        />
      </div>
    </div>
    <div class="grid lg:grid-cols-[194px_auto] items-center">
      <div class="font-semibold text-sm">NADAI Date:</div>
      <div class="h-32 relative">
        <!-- <Textbox :placeholder="'edit placeholder'" /> -->
        <!-- <input
          type="text"
          class="bg-[initial] text-sm border-[1px] border-[#3a354147] flex items-center cursor-default rounded-md w-full px-3 h-full focus:ring-0 focus:outline-none focus:border-[#3a354147] py-[auto]"
          v-model="trustReceipt.nadaiDate"
          :disabled="childData ? 1 : 0"
        /> -->
        <input
          type="date"
...
<script setup>
import FundTitle3 from "./FundTitle3.vue";
import Textbox from "../reusableComponents/Textbox.vue";
import Dropdown from "../reusableComponents/Dropdown.vue";
</script>
