<template>
    ...
    <div class="flex justify-center items-center flex-col">
        <div class="mx-[50px] mt-[50px]">
            <span class="text-[22px] font-bold uppercase">transfer from other government agencies</span>
            <div class="flex flex-col gap-2 mt-[25px]">
                <div class="flex flex-row gap-2 h-[32px] items-center">
                    <span class="text-[14px] font-semibold w-[200px]">Type of Company:</span>
                    <span>{{ responseData.government_type }}</span>
                </div>
                <div class="flex flex-row gap-2 h-[32px] items-center">
                    <span class="text-[14px] font-semibold w-[200px]">Name of Agency:</span>
                    <span>{{ responseData.agency_name }}</span>
                </div>
                <div class="flex flex-row gap-2 h-[32px] items-center">
                ...
                <div class="flex flex-row gap-14 h-[32px] items-center">
                    <div class="flex flex-row gap-2 h-[32px] w-[460px] items-center">
                        <span class="text-[14px] font-semibold w-[200px]">NADAI No.:</span>
                        <span>{{ responseData.nadai_no }}</span>
                    </div>
                    <div class="flex flex-row gap-2 h-[32px] w-[460px] items-center">
                        <span class="text-[14px] font-semibold w-[200px]">NADAI Date:</span>
                        <span>{{ responseData.nadai_date }}</span>
                    </div>
                </div>
                <div class="flex flex-row gap-14 h-[32px] items-center">
                    <div class="flex flex-row gap-2 h-[32px] w-[460px] items-center">
                        <span class="text-[14px] font-semibold w-[200px]">Official Receipt No.:</span>
                        <span>{{ responseData.official_receipt_no }}</span>
                    </div>
                    <div class="flex flex-row gap-2 h-[32px] w-[460px] items-center">
                        <span class="text-[14px] font-semibold w-[200px]">Official Receipt Date:</span>
                        <span>{{ responseData.official_receipt_date }}</span>
                    </div>
                </div>
                <div class="flex flex-row gap-14 h-[32px] items-center">
                    <div class="flex flex-row gap-2 h-[32px] w-[460px] items-center">
                    ...
                    <div class="flex flex-row gap-2 h-[32px] w-[460px] items-center">
                        <span class="text-[14px] font-semibold w-[200px]">Official Receipt Amount:</span>
                        <span>{{ responseData.official_receipt_amount }}</span>
                    </div>
                </div>
            </div>
        </div>
