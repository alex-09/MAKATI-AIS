<template>
    ...
    <div class="flex justify-center items-center flex-col">
        <div class="mx-[50px] mt-[50px]">
            <span class="text-[22px] font-bold uppercase">LGU Counterpart Contribution for Specific Projects</span>
            <div class="flex flex-col gap-2 mt-[25px]">
                ...
                <div class="flex flex-row gap-14items-center">
        ...
        <div class="mx-[50px] w-[1143px] max-h border-[6px] border-[#FFECB3] p-8 flex-col flex rounded-[32px]">
            <div class="flex flex-row gap-2 h-[32px] items-center">
