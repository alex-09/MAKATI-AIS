...
<script>
import HeaderMenu from "../../../components/PCICM/headerMenu.vue";
import navBarMenu from "../../../components/PCICM/navBarMenu.vue";
export default {
  components: {
    HeaderMenu,
    navBarMenu,
...
<template>
  ...
  <div>
    <ul
      class="gap-x-[158px] flex text-[#3A354199] justify-center font-medium text-[14px] leading-[24px]"
    >
      <li
        ...
        :class="[
          i == selectedIndex
            ? 'border-b-4 border-[#05c46b] text-[#05c46b]'
            : '',
          'px-[20px] py-[12px] text-center cursor-pointer select-none',
        ]"
