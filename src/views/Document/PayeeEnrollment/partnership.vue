            ...
            <div class="container grid place-content-center px-0">
                <div class="grid grid-rows-7 grid-flow-row gap-2 mt-2">
                    <div class="flex flex-row my-1 items-center">
                        <span class="font-semibold text-sm text-other-black w-210">Complete Registered<br>Business Nme</span>
                        <input 
                        type="text" 
                    ...
                    <div class="flex flex-row my-1 items-center">
                        <span class="font-semibold text-sm text-other-black w-210">SEC Registrationtion No.</span>
                        <input 
                            type="text" 
                            class="ml-2 w-420 xxxxl:w-12 h-40 border rounded px-2 pl-3 focus:outline-none focus-visible:ring-white border-input-color text-sm text-gray-500 " 
                            placeholder=""
        ...
        async submitPayee() {
            try {
                const createPayee = {
                    ...
                    business_name: this.registeredName,
