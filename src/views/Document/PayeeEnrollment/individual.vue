<template>
    <div class="container p-0 font-Inter">
        <div class="mt-5 mx-40">
            <div class="container grid place-content-center px-0 justify-start -ml-10">
                <div class="grid grid-rows-7 grid-flow-row gap-2 mt-2">
                    <div class="flex flex-row my-1 items-center">
                        <span class="font-semibold text-sm text-other-black w-210">Complete Individual Name</span>
                        <input 
                            type="text" 
                            class="ml-2 w-12 xxxxl:w-12 h-40 border rounded px-2 pl-3 focus:outline-none focus-visible:ring-white border-input-color text-sm text-gray-500"
                    ...
                    <div class="flex flex-row my-1 items-center">
                        <span class="font-semibold text-sm text-other-black w-210">DTI Registrationtion No.</span>
                        <input 
                            type="text" 
                            class="ml-2 w-420 xxxxl:w-12 h-40 border rounded px-2 pl-3 focus:outline-none focus-visible:ring-white border-input-color text-sm text-gray-500 " 
                            placeholder=""
