        ...
        <table class="min-w-max w-full table-fixed">
          <thead>
            <tr class="text-gray-600 uppercase text-sm leading-normal">
              ...
              <th class="py-3 px-6 text-left">AIP Reference</th>
          ...
          <tbody class="text-gray-600 text-sm leading-normal">
            ...
            >
              ...
              <td class="py-3 px-6 text-left">
                {{ listitem.allot_amount.toLocaleString() }}
              </td>
              ...
              <td class="py-3 px-6 text-left text-gray-500" v-else>
                {{ listitem.status == null ? "For Review" : listitem.status }}
              </td>
...
export default {
  ...
  async created() {
    await axios.get("allotment/listAllot").then((res) => {
